...
export const PhotoIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
...
// Added missing icons
export const GiftIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const CheckBadgeIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
/**
 * Star icon used for ratings and decorations.
 * Fixed error where StarIcon was imported but not exported from Icons.tsx.
 */
export const StarIcon: React.FC<IconProps> = ({ className = 'h-6 w-6', filled = false }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth={1.5}>
...
export const AddIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
  </svg>
);
...
export const AppearanceIcon: React.FC<IconProps> = ({ className = 'h-6 w-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.75 3l-3.5 3.5m0 0L7.75 10m-3.5-3.5h15.5m-3.5 11l3.5-3.5m0 0l-3.5-3.5m3.5 3.5H4.25" />
  </svg>
);
