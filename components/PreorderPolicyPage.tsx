    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      >
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Production Timelines</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Handmade Variations</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4">Delivery Delays</h2>
          <p>
