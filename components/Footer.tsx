      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 border-t border-border-primary pt-8 text-center flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
                <button onClick={() => onNavigate('customerLove')} className="text-sm text-text-secondary/60 hover:text-accent-primary transition-colors">
                    Customer Love
                </button>
                <button onClick={() => onNavigate('preorderPolicy')} className="text-sm text-text-secondary/60 hover:text-accent-primary transition-colors">
                    Preorder Policy
                </button>
