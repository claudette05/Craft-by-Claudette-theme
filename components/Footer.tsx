        ...
        <div className="text-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
                ...
                <a 
                  href={emailUrl}
                  className="inline-flex items-center gap-2 text-sm font-bold text-accent-primary hover:opacity-80 transition-opacity bg-accent-primary/10 px-6 py-3 rounded-full border border-accent-primary/30"
                >
