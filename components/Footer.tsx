...
const FooterLink: React.FC<{ href: string, children: React.ReactNode }> = ({ href, children }) => (
    <li>
        <a href={href} className="text-zinc-600 hover:text-amber-600 transition-colors duration-200">
            {children}
        </a>
    </li>
);
    ...
    <footer className="bg-white border-t border-pink-200">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          {/* Links */}
          <div>
            <h4 className="font-bold text-zinc-800 mb-4">Shop</h4>
            <ul className="space-y-2">
              <FooterLink href="#">Resin</FooterLink>
              <FooterLink href="#">Beads</FooterLink>
              <FooterLink href="#">Keychains</FooterLink>
              <FooterLink href="#">All Products</FooterLink>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-zinc-800 mb-4">Company</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="font-bold text-zinc-800 mb-4">Support</h4>
            <ul className="space-y-2">
