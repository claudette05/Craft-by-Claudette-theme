<?php
/**
 * Custom Navigation Walker for My Vibe Theme (Mobile).
 *
 * @package My_Vibe_Theme
 */

if ( ! class_exists( 'Craft_By_Claudette_Nav_Walker_Mobile' ) ) { // Keep original class name for compatibility with existing header.php
